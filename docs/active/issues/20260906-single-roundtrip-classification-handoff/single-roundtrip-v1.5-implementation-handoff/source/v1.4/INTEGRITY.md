...
- accepted baseline 3-Class final sha256: `8c95a01ead137927c8a7d9b23c81deee41bcd8e7647e58fe072bdfffcabb5ff6`
- unresolved optional P2: 1
- acceptance: `reference/INTEGRATED_ACCEPTANCE_REPORT.json`
- tests: `python tests/run_all_tests.py`

`manifest.json` に、`INTEGRITY.md` と `manifest.json` 自身を除く配布ファイルの SHA-256 と byte size を記録しています。
